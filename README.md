...
**Live** - MHS: https://www.hijabstore.modest.co.in/

### 🤖 AI Chatbot (SHAWARMAA)
Built a **Groq LLM-powered chatbot** using **Streamlit** with session memory and custom prompts.
**Live** - MHS: https://shawarmaa.streamlit.app/

### 😷 Face Mask Detection
Developed a **YOLO-based face mask detection model** trained on a custom dataset and deployed with Streamlit.
**Live** - Face Mask Detection: https://masknomask.streamlit.app/

### 📊 Netflix Data Analysis
Extracted insights and viewing trends using **Pandas** and **Matplotlib**.
...
- AI Chatbot: https://shawarmaa.streamlit.app/


---

![](https://komarev.com/ghpvc/?username=aarebkhan02&color=blue)

> Building practical products with code, data, and AI.
